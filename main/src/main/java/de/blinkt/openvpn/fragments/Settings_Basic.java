...
public class Settings_Basic extends KeyChainSettingsFragment implements OnItemSelectedListener, FileSelectLayout.FileSelectCallback {
    ...
    private void changeType(int type) {
        // hide everything
        mView.findViewById(id.pkcs12).setVisibility(View.GONE);
        mView.findViewById(id.certs).setVisibility(View.GONE);
        mView.findViewById(id.statickeys).setVisibility(View.GONE);
        mView.findViewById(id.keystore).setVisibility(View.GONE);
        mView.findViewById(id.cacert).setVisibility(View.GONE);
        ((FileSelectLayout) mView.findViewById(id.caselect)).setClearable(false);
        mView.findViewById(id.userpassword).setVisibility(View.GONE);
        mView.findViewById(id.key_password_layout).setVisibility(View.GONE);
        mView.findViewById(id.external_auth).setVisibility(View.GONE);

        // Fall through are by design
        switch (type) {
            case VpnProfile.TYPE_USERPASS_CERTIFICATES:
                mView.findViewById(id.userpassword).setVisibility(View.VISIBLE);
            case VpnProfile.TYPE_CERTIFICATES:
                mView.findViewById(id.certs).setVisibility(View.VISIBLE);
                mView.findViewById(id.cacert).setVisibility(View.VISIBLE);
                if (mProfile.requireTLSKeyPassword())
                    mView.findViewById(id.key_password_layout).setVisibility(View.VISIBLE);
                break;

            case VpnProfile.TYPE_USERPASS_PKCS12:
                mView.findViewById(id.userpassword).setVisibility(View.VISIBLE);
            case VpnProfile.TYPE_PKCS12:
                mView.findViewById(id.pkcs12).setVisibility(View.VISIBLE);
                mView.findViewById(id.cacert).setVisibility(View.VISIBLE);
                ((FileSelectLayout) mView.findViewById(id.caselect)).setClearable(true);
                break;

            case VpnProfile.TYPE_STATICKEYS:
                mView.findViewById(id.statickeys).setVisibility(View.VISIBLE);
                break;

            case VpnProfile.TYPE_USERPASS_KEYSTORE:
                mView.findViewById(id.userpassword).setVisibility(View.VISIBLE);
            case VpnProfile.TYPE_KEYSTORE:
                mView.findViewById(id.keystore).setVisibility(View.VISIBLE);
                mView.findViewById(id.cacert).setVisibility(View.VISIBLE);
                ((FileSelectLayout) mView.findViewById(id.caselect)).setClearable(true);
                break;
            ...
            case VpnProfile.TYPE_EXTERNAL_APP:
                mView.findViewById(id.external_auth).setVisibility(View.VISIBLE);
                break;
        }
